...
if SAVE_PDF == true
    if WANT_LEGEND == true
        print('-dpdf', PDF_RESOLUTION, [save_PDF_Path 'Accuracy_Feedback_and_Periphery_FullScreen_Legend_' date '.pdf'])
        winopen([save_PDF_Path 'Accuracy_Feedback_and_Periphery_FullScreen_Legend_' date '.pdf'])
    elseif WANT_LEGEND==false
        print('-dpdf', PDF_RESOLUTION, [save_PDF_Path 'Accuracy_Feedback_and_Periphery_FullScreen_' date '.pdf'])
        winopen([save_PDF_Path 'Accuracy_Feedback_and_Periphery_FullScreen_' date '.pdf'])
    end
end
...
if SAVE_PDF == true
    if WANT_LEGEND == true
        print('-dpdf', PDF_RESOLUTION, [save_PDF_Path 'Accuracy_Feedback_and_Periphery_HalfScreen_Legend_' date '.pdf'])
        winopen([save_PDF_Path 'Accuracy_Feedback_and_Periphery_HalfScreen_Legend_' date '.pdf'])
    elseif WANT_LEGEND==false
        print('-dpdf', PDF_RESOLUTION, [save_PDF_Path 'Accuracy_Feedback_and_Periphery_HalfScreen_' date '.pdf'])
        winopen([save_PDF_Path 'Accuracy_Feedback_and_Periphery_HalfScreen_' date '.pdf'])
    end
end
